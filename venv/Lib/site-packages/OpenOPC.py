      ...
      try:
         ...
         for tag in tags:
            ...
            if id == None:
               ...
               tag_properties = list(zip_longest(property_id, descriptions))
            ...
            if id != None:
               if single_property:
                  ...
                  tag_properties = list(zip_longest(property_id, values))
            else:
               tag_properties = list(zip_longest(property_id, descriptions, values))
